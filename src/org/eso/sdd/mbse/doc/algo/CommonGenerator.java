...
*/
	...
	private void processDiagramTable(Element el, StringBuffer prefix, StringBuffer postfix, StringBuffer content, List<Element> navigateDown) { 
		String sContent = "";
		...
		dpe = theUtilities.getPROJECT().getDiagram(theDiagram);
		//if(! dpe.isLoaded()) {
		...
		// Integer type
		columnWidth.addAll( StereotypesHelper.getStereotypePropertyValue(theDiagram,	theDiagramTableStereo, "columnWidth") );
